            ...
            <div class="tabs">
              <div class="row">
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="active">
                      <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-thumb-01.jpg" alt="">
                      <h4>Ruby Foster</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-thumb-03.jpg" alt="">
                      <h4>Luis Oconnell</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-thumb-02.jpg" alt="">
                      <h4>Jackie Riggs</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-thumb-04.jpg" alt="">
                      <h4>Alfred Small</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-thumb-05.jpg" alt="">
                      <h4>Denis Mitchel</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                  </div>
                    ...
                    <li class="active">
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-01.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-03.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-02.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-04.jpg" alt="">
                        </div>
                      </div>
                      </li>
                      <li>
                        <div>
                          ...
                          <div class="right-image">
                            <img src="<?php echo base_url('assets/User/'); ?>assets/images/team-member-05.jpg" alt="">
                          </div>
                        </div>
                        </li>
                    </ul>
