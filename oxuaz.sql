...
--
-- Host: 127.0.0.1
-- Hazırlanma Vaxtı: 09 Mar, 2023 saat 22:10
...
INSERT INTO `news` (`n_id`, `n_title`, `n_description`, `n_date`, `n_category`, `n_status`, `c_teacher`, `n_img`, `n_file_ext`, `n_creator_id`, `n_create_date`, `n_updater_id`, `n_update_date`) VALUES
(22, 'adsfbgf', 'sddsvfbdgvhnbm', '2022-10-21', 'Sport', 'Deactive', 'Rza', '07580cb3157add5b44d1454b8f2bd216.jpg', '.jpg', 2, '2022-10-21 20:38:49', 2, '2022-10-22 12:53:59'),
(23, 'Yaponiya millisinin sabiq futbolçusu 32 yaşında vəfat edib', 'Yaponiya millisinin sabiq futbolçusu Masato Kudo vəfat edib.\r\n\r\n\"Report\" \"Reuters\"ə istinadən xəbər verir ki, hücumçu beyin əməliyyatından sonra 32 yaşında dünyasını dəyişib.\r\n\r\nForvard oktyabrın 3-də xəstəxanaya yerləşdirilmişdi.\r\n\r\nQeyd edək ki, Masato Kudo yığmanın heyətində dörd oyun keçirib və iki qol vurub. Hücumçu ölkəsində \"Kasiva Reysol\"dakı çıxışına görə tanınıb', '2022-10-22', 'Sport', 'Active', 'Mahmud', 'bad9af7eaab33031b94d4ab06c581e5b.png', '.png', 1, '2022-10-22 12:57:21', 0, ''),
...
(45, 'sadsadasdsadsadsa', 'sdadsadsa', '2023-03-14', 'Technology', 'Active', '', 'b2bf0a6119276c89da7ef4c87aae1912.png', '.png', 1, '2023-03-02 19:53:30', 1, '2023-03-02 19:56:39'),
(46, '231123', '21321312', '2023-03-23', 'Technology', 'Active', '', '', '', 1, '2023-03-02 19:57:38', 0, ''),
(47, '', '', '', '', '', '', '', '', 0, '', 0, ''),
(48, 'sad', 'sadsadasdsa', '2023-03-15', 'IT', 'Active', '', '', '', 1, '2023-03-09 21:48:31', 1, '2023-03-09 21:50:29');
